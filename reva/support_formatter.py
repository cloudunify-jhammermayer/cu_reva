...
def format_support_html(result: SupportAnswerResult) -> str:
    ...
    # NOTE: answer_status, confidence and request_kind deliberately do NOT
    # appear here. The consultant sends this HTML on to the customer verbatim
    # through the mail composer, so REVA's own assessment of its work would go
